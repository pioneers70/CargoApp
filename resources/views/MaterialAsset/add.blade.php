<x-app-import-layout>
    ...
    <div class="container bg-gradient-dull shadow p-3 mb-5 rounded">
        <form action="{{ route('materialAssets.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div>
                <label for="name" class="form-label display-6 text-shadow">Добавить новое оборудование</label>
                    ...
                    <div class="col-5">
                        ...
                        @foreach($tags as $tag)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" value={{ $tag->id }} id="tags"
                                       name="tags[] multiple">
