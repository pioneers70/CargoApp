        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-center w-100">
                ...
                <li class="nav-item dropdown btn btn-outline-light me-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item dropdown-hover" href="{{route('operations.index')}}">Последние
                                операции</a></li>
                        <li><a class="dropdown-item dropdown-hover" href="{{ route('inventories.index') }}">Остатки на
                                складах</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown btn btn-outline-light me-1">
                ...
                <li class="nav-item dropdown btn btn-outline-light me-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item dropdown-hover" href="{{ route('vpuObjects.index') }}">Все объекты
                                ВПУ</a></li>
